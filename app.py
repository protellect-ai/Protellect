...
RESEARCH_DOMAINS = {
    "Neuroscience": {
        ...
        "key_experiments": [
            ("iPSC-Neurons (NGN2)", "2–3 weeks", "Gold standard neural model", "#22c55e"),
            ("Patch-clamp electrophysiology", "1–2 weeks", "Action potential + ion channel function", "#22c55e"),
            ("Calcium imaging (GCaMP)", "1 week", "Network activity — seizure, synchrony", "#ffd60a"),
            ("Mitochondrial membrane potential", "3 days", "MitoTracker / JC-1 — energy failure", "#ffd60a"),
            ("Tau / α-synuclein aggregation", "2–4 weeks", "ThT fluorescence or FRET assay", "#ff8c42"),
            ("BBB permeability assay", "1 week", "PAMPA-BBB or hCMEC/D3 transwell", "#ff8c42"),
        ],
        "drug_rules": [
    ...
    "Cancer Biology": {
        ...
        "key_experiments": [
            ("CRISPR GoF/LoF screen", "4–6 weeks", "Validate driver status in cancer cell line", "#22c55e"),
            ("Clonogenic survival assay", "2 weeks", "Colony formation after drug treatment", "#22c55e"),
            ("ctDNA panel sequencing", "1 week", "Liquid biopsy — track clonal dynamics", "#22c55e"),
            ("Xenograft (PDX) model", "10–16 weeks", "Patient-derived tumour engraftment", "#ff8c42"),
            ("Phosphoproteomics", "2 weeks", "Kinase substrate landscape in tumour", "#ffd60a"),
            ("ChIP-seq (TF targets)", "2 weeks", "Transcription factor binding landscape", "#ffd60a"),
        ],
        "drug_rules": [
    ...
    "Molecular Biology": {
        ...
        "key_experiments": [
            ("ADP-Glo kinase assay", "1 week", "Vmax/Km — WT vs variants", "#22c55e"),
            ("Co-IP + mass spec (AP-MS)", "2 weeks", "Interactome — pull-down + LC-MS/MS", "#22c55e"),
            ("HDX-MS (dynamics)", "2 weeks", "Conformational flexibility mapping", "#ffd60a"),
            ("Thermal shift assay", "3 days", "Stability — compound engagement", "#ffd60a"),
            ("FRET / BRET proximity", "1 week", "Real-time interaction in live cells", "#ffd60a"),
            ("Cryo-EM / X-ray structure", "6–18 months", "Atomic-resolution structure", "#ff8c42"),
        ],
        "drug_rules": [
...
def render_domain_expansion_cards(pdata, cv_variants, scored, am_scores, research_domain, gene, uid, pdb):
    ...
    for idx_d, feat in enumerate(domain_features[:20]):
        ...
        domain_variants = [v for v in path_variants
                          if start_pos <= int(v.get("start", 0)) <= end_pos]
